...
setup(name='assistive-gym',
    ...
    install_requires=['gym>=0.2.3', 'pybullet @ git+https://github.com/Zackory/bullet3.git@pybullet_3_0_9#egg=pybullet', 'numpy==1.22.0', 'keras==2.6.0', 'tensorflow==2.4.4', 'h5py==2.10.0', 'smplx', 'trimesh', 'ray[rllib]', 'numpngw', 'tensorflow-probability==0.7.0', 'matplotlib'] + ['screeninfo==0.6.1' if sys.version_info >= (3, 6) else 'screeninfo==0.2'],    # description='Physics simulation for assistive robotics and human-robot interaction.',
