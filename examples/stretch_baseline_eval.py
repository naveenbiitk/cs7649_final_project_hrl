...
def evaluate_baseline(seed):
    ...
    for episode in range(n_episodes):
        ...
        #     action = target_pose_angles_2-current_joint_angles
            ...
            if count_<80:
                action[0] = (human_target[1]-base_pose[1]+y_offset)*5
                action[1] = action[0]
                action[2:5]=target_pose_angles_1-current_joint_angles
            else:
                action[2:5] = target_pose_angles_2-current_joint_angles

            #print('count: ',count_,' Actions: ',env.tool_force)
